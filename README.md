...
Wave Catch — кроссплатформенный музыкальный плеер с удобным интерфейсом для управления локальной музыкальной библиотекой. Приложение позволяет собирать коллекцию треков, упорядочивать их и слушать без браузера и сторонних сервисов.
