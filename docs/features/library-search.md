...
Поиск одновременно по исполнителям, альбомам и трекам. Результаты отображаются в контентной области при вводе запроса в поле в сайдбаре.

## UX

- Поле **«Поиск»** — в сайдбаре под заголовком «Music Player», всегда доступно.
...
| Трек | Сброс маршрута → экран альбома → панель информации о треке |
